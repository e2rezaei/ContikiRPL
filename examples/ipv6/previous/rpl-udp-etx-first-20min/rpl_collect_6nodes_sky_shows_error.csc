...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/rpl-udp-etx-first-20min/udp-server.c</source>
      <commands EXPORT="discard">make udp-server.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/rpl-udp-etx-first-20min/udp-server.sky</firmware>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/rpl-udp-etx-first-20min/udp-client.c</source>
      <commands EXPORT="discard">make udp-client.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/rpl-udp-etx-first-20min/udp-client.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <motetype>
      ...
      <source EXPORT="discard">/home/e2rezaei/Documents/Research/Implementation/SIMULATION/ContikiRPL/examples/ipv6/rpl-udp-etx-first-20min/udp-client-11.c</source>
      <commands EXPORT="discard">make udp-client-1.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/rpl-udp-etx-first-20min/udp-client-1.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.5025252525252526 0.0 0.0 1.5025252525252526 24.121212121212057 -56.15855823356675</viewport>
    </plugin_config>
    <width>656</width>
    <z>2</z>
    <height>620</height>
...
var node1 = sim.getMoteWithID(1);
 node1.getInterfaces().getPosition().setCoordinates(100, 300, 0);

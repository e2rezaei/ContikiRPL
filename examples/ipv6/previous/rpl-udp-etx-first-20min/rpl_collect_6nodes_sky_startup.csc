...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/rpl-udp-etx-first-20min/udp-client-1.c</source>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.5025252525252526 0.0 0.0 1.5025252525252526 68.12121212121201 -18.158558233566733</viewport>
    </plugin_config>
    <width>731</width>
    <z>3</z>
    <height>620</height>
...
if(msg.equals("move-1")) {
         ...
         node1.getInterfaces().getPosition().setCoordinates(0,150, 0);        

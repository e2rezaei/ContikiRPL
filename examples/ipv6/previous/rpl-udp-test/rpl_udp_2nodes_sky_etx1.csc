...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/rpl-udp-test/udp-server.c</source>
      <commands EXPORT="discard">make udp-server.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/rpl-udp-test/udp-server.sky</firmware>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/rpl-udp-test/udp-client.c</source>
      <commands EXPORT="discard">make udp-client.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/rpl-udp-test/udp-client.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>52.05774958734273</x>
        <y>-0.34984480641485893</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>51.04610376779538</x>
        <y>100.81473714832003</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.9884882442824113 0.0 0.0 0.9884882442824113 168.54152650911416 14.345817478464344</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
&#xD;
 while (true) {&#xD;
    ...
    if(! outputs[id.toString()]){&#xD;
        ...
        outputs[id.toString()]= new FileWriter("Logs/" + id +".txt");&#xD;
    }&#xD;
    //Write to file.&#xD;

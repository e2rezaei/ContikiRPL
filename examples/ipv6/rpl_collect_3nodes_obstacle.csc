...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>103.55109226955211</x>
        <y>11.134296633776406</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>196.41816921782865</x>
        <y>68.18121533057486</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>29.25743071093088</x>
        <y>166.35498239018148</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.7537655141120395 0.0 0.0 0.7537655141120395 70.94675769857781 74.60735117356558</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
